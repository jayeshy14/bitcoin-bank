      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              We're revolutionizing the way people access liquidity in the crypto space.
            </p>
            <div className="flex space-x-4 pt-2">
              ...
              {['twitter', 'facebook', 'instagram', 'linkedin'].map((social) => (
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-gray-700 hover:bg-blue-600 flex items-center justify-center transition-colors duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { name: 'My Loans', path: '/loans/my-loans' },
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { name: 'FAQ', path: '/faq' },
                { name: 'Bitcoin Basics', path: '/bitcoin-basics' },
                { name: 'Loan Calculator', path: '/simulator' },
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:support@bitcoinloanbank.com" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
                  support@bitcoinloanbank.com
                </a>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+15551234567" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
                  +1 (555) 123-4567
                </a>
              </li>
              <li className="flex items-center">
          ...
          <div className="max-w-xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                ...
                className="flex-grow px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
              <button 
                type="submit" 
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-500 hover:to-indigo-600 text-white font-medium rounded-lg transition-colors duration-300"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {currentYear} Bitcoin Loan Bank. All rights reserved.
          </p>
